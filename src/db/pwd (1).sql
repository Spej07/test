...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2025 at 03:24 AM
...
(26, 'Jayem', 'Rosalita', 'Jayem12', 'FeKw08M4keuw8e9gnsQZQgwg4yDOlMZfvIwzEkSOsiU=', '23', 'Minglanilla', 'Blind', 'Resident', 'Active'),
(27, 'Admin', 'Admin', 'Admin', 'LazuvE4xZU0yaueImzl+1Q/35a//N00fiVJYZf2H7+A=', '25', 'Minglanilla', 'Admin', 'Resident', 'Active');
...
--
ALTER TABLE `user`
  MODIFY `r_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
COMMIT;
